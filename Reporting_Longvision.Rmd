...
{
  data.Performer.pattern<- subset(data.Performer.clean,Symbol==Sym)
  #data.Performer.pattern<-data.Performer.pattern[1:100,]
  for(t in Timeframe)
  {
    data.Performer.pattern<-Pattern.KnitWithData(data.Performer.pattern,
                                                 data.History[[Sym]][[t]],
...
data.Pattern.Entries<-Pattern.Entries(data.Performer.pattern.ScaledPrice,Timeframe, xBars)
