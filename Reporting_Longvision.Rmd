...
data.Performer.clean.EURUSD<- data.Performer.clean[data.Performer.clean$Symbol=="EURUSD",]
...
data.EURUSD.M5<-ImportHistory("EURUSD","M5")
...
#EURUSD
##M5
checkSync(data.Performer.clean.EURUSD,data.EURUSD.M5)
##M15
checkSync(data.Performer.clean.EURUSD,data.EURUSD.M15)
...
#EURUSD
data.Performer.Symbol<- subset(data.Performer.clean,Symbol=="EURUSD")


##All Timeframes
TF<-"M5"
data.History<-data.EURUSD.M5
data.Performer.pattern<-Pattern.KnitWithData(data.Performer.Symbol, data.History,Bars.Lookback,TF,timestamp=TRUE,netto =  FALSE,Normalized =  FALSE,rm.open =  FALSE)

#----
TF<-"M15"
data.History<-data.EURUSD.M15
data.Performer.pattern<-Pattern.KnitWithData(data.Performer.pattern, data.History,Bars.Lookback,TF,timestamp=TRUE,netto =  FALSE,Normalized =  FALSE,rm.open =  FALSE)

# #----
# TF<-"H1"
# 
# data.Performer.pattern<-Pattern.KnitWithData(data.Performer.Symbol, data.History,Bars.Lookback,TF)
# 
# #----
# TF<-"H4"
# 
...
head(data.Performer.pattern,20)

rm(data.Performer.clean)
rm(data.Performer.Symbol)
```
